...
namespace StupidTemplate.Patches.Internal
{
    public class IncrementRPCPatches
    {
        ...
        [HarmonyPatch(typeof(GorillaTelemetry), "IncrementRPCCall", typeof(PhotonMessageInfo), typeof(string))]
        ...
        [HarmonyPatch(typeof(GorillaTelemetry), "IncrementRPCCallLocal")]
