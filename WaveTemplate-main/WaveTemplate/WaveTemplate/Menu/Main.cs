...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            menuBackground.GetComponent<Renderer>().material.color = Color.gray;
                ...
                transform =
        {
            ...
            if (disconnectButton)
            {
                ...
                disconnectbuttonOutline.GetComponent<Renderer>().material.color = Color.gray;
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            gameObject.GetComponent<Renderer>().material.color = Color.darkGray;
        ...
        public static (RaycastHit Ray, GameObject NewPointer) RenderGun(int? overrideLayerMask = null)
        {
            ...
            GunLine.startColor = Color.darkGray;
            GunLine.endColor = Color.darkGray;
        ...
        public static void CubePointer()
        {
            if (GunPointer == null)
            GunPointer = GameObject.CreatePrimitive(PrimitiveType.Cube);
            else
            {
                GunPointer = GameObject.CreatePrimitive(PrimitiveType.Sphere);
            }
